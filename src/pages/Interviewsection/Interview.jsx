...
//             </label>
// 			  <button onSubmit={(setEditorContent(true))}>open editor for answer</button>
// 			{editor && <div  className="row-span-3">
...
//             <button
//               type="submit"
//               className="bg-blue-600 text-white text-base sm:text-lg py-2 px-6 rounded-lg"
//             >
