    ...
    return (
        <div className="bg-black min-h-screen p-5">
            ...
            <div className="md:hidden flex justify-between items-center mb-4">
                <h2 className="text-white text-xl font-bold">Start Preparation</h2>
                <button
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-7 gap-4">
                ...
                >
                    <div className="space-y-4">
                        {[
                            { label: "By Technology/Skills", name: "skill", options: skills },
                            { label: "By Industry/Domain", name: "Domain", options: domains },
                            { label: "By Company", name: "companyName", options: companyNames },
                            { label: "By Job Role", name: "role", options: roles },
                            { label: "By Question Type", name: "questiontype", options: questionTypes },
                            { label: "By Difficulty Level", name: "difficulty", options: difficulties },
                            { label: "By Experience Level", name: "ExperienceLevel", options: experienceLevels },
                        ].map((filter, index) => (
                            <div key={index} className="mb-4">
                                <label className="block mb-1 text-white font-medium" htmlFor={filter.name}>
                                    {filter.label}
                                </label>
                                <select
                                    name={filter.name}
