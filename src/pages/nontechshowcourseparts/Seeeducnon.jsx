...
const SeeEducationCardnon = ({ field }) => {
	return (
		<div className="p-5 m-2 rounded-md w-56 bg-gray-800 flex flex-col   justify-between  shadow-lg cursor-pointer ">
			...
			<Link
				to={`/explorenontech?branch=${field.branchname}`}
				state={{ field: field }}
				className="flex  hover:no-underline   no-underline flex-row justify-start items-center text-white bg-pink-600 p-3 m-1 rounded-lg hover:scale-105 cursor-pointer duration-200">
